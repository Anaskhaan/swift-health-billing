...
export const ARDenialManagement = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      items: ["Revenue tracking", "Trend analysis", "Performance benchmarking"],
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Our AR and Denial management solutions optimize cash flow, reduce
            claim rejections, and ensure faster reimbursements.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
              Discover how our AR & Denial Management solutions can maximize
              your reimbursements and minimize payment delays.
            </p>
